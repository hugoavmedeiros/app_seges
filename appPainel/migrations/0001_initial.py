# Generated by Django 4.2.4 on 2023-09-22 12:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orgao_cd', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^\\d{1,10}$')], verbose_name='Código do Órgão')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secretaria_cd', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^\\d{1,10}$')], verbose_name='Código da Secretaria')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secretaria', models.CharField(max_length=255, verbose_name='Nome da Secretaria')),
                ('secretaria_cd', models.CharField(db_index=True, max_length=10, validators=[django.core.validators.RegexValidator('^\\d{1,10}$')], verbose_name='Código da Secretaria')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('orgao', models.CharField(max_length=255, verbose_name='Nome do Órgão')),
                ('orgao_cd', models.CharField(db_index=True, max_length=10, validators=[django.core.validators.RegexValidator('^\\d{1,10}$')], verbose_name='Código do Órgão')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
