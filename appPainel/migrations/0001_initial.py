# Generated by Django 4.2.4 on 2023-10-10 14:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eixo_estrategico_cd', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^\\d{1,10}$')], verbose_name='Código do Eixo')),
                ('descricao', models.TextField(blank=True, verbose_name='Descrição')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tema', models.TextField(verbose_name='Tema')),
                ('descricao', models.TextField(verbose_name='Descrição')),
                ('populacao', models.IntegerField(blank=True, verbose_name='População')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('eixo_estrategico', models.CharField(max_length=255, verbose_name='Nome do Eixo')),
                ('eixo_estrategico_cd', models.CharField(db_index=True, max_length=10, validators=[django.core.validators.RegexValidator('^\\d{1,10}$')], verbose_name='Código do Eixo')),
                ('descricao', models.TextField(blank=True, verbose_name='Descrição')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
